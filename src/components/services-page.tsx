  ...
  return (
    <div className="">
      ...
      <div className="fixed right-4 bottom-4 md:right-8 md:bottom-8">
        <Link
          href="/contact"
          className="inline-block py-3 px-6 text-white bg-gray-800 rounded-md shadow-lg hover:bg-gray-700 focus-visible:ring-2 focus-visible:ring-gray-600 focus-visible:ring-opacity-50"
        >
          Get a Free Quote
        </Link>
      </div>
